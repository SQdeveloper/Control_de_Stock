...
public class ControlDeStockFrame extends JFrame {
    ...
    private void configurarTablaDeContenido(Container container) {
        ...
        modelo.addColumn("Identify of producto");
        modelo.addColumn("name of producto");
    ...
    private void guardar() {
        ...
        Producto producto = new Producto(textoNombre.getText(), textoDescripcion.getText(), cantidadInt, categoria.getId());        
